...
class _HomeVenueState extends State<HomeVenue> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    FirebaseDatabase.instance.reference().child("Venue").child("VenueReservation").orderByChild("incharge").equalTo("Pending").once().then((DataSnapshot dataSnapshot) async{
