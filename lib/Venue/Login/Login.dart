...
class LoginVenue extends StatefulWidget {
  @override
  _LoginVenueState createState() => _LoginVenueState();
}
     ...
     return WillPopScope(
      ...
      color: Colors.white,
        child: Column(
          ...
          children: <Widget>[
            Center(
            child: Text('Venue Event Proposal', style: TextStyle(
            fontFamily: "Mops",
                              ...
                              if(values==null){
                                ...
                                values.forEach((key,values){
                                  if(values["id"]==schoolID.text && values["password"]==password.text){
                                    ...
                                    schoolID.clear();
                                    password.clear();
                                    Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) => HomeVenue(id: values["id"].toString(),), fullscreenDialog: true));
                                  });
                                  }else{
                                  setState(() {
                                    isload =false;
