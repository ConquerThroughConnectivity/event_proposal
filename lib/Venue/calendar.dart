...
bool isWide =true;
class VenueCalendar extends StatefulWidget {
  final String id;
  VenueCalendar({this.id});
  @override
  _VenueCalendarState createState() => _VenueCalendarState();
}

class _VenueCalendarState extends State<VenueCalendar> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 0.4,
        leading: IconButton(icon: Icon(Icons.arrow_back_ios), onPressed: ()=> Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) => HomeVenue(id: widget.id,), fullscreenDialog: true))),
