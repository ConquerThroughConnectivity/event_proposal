...
bool isWide =true;
class VenueApproverCalendar extends StatefulWidget {
  final String id;
  VenueApproverCalendar({this.id});
  @override
  _VenueApproverCalendarState createState() => _VenueApproverCalendarState();
}

class _VenueApproverCalendarState extends State<VenueApproverCalendar> {
