...
class DeniedEventApprovers extends StatefulWidget {
  final String orgname;
  DeniedEventApprovers({Key key, this.orgname}): super(key: key);
  @override
  _DeniedEventApproversState createState() => _DeniedEventApproversState();
}

class _DeniedEventApproversState extends State<DeniedEventApprovers> {
  @override
