...
class AcceptedVenueApprovers extends StatefulWidget {
  final String orgname;
  AcceptedVenueApprovers({Key key, this.orgname}): super(key: key);
  @override
  _AcceptedVenueApproversState createState() => _AcceptedVenueApproversState();
}

class _AcceptedVenueApproversState extends State<AcceptedVenueApprovers> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Accepted Venue", style: TextStyle(
           fontFamily: "Mops",
