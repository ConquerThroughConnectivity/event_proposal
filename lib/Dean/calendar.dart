...
bool isWide =true;
class DeanCalendar extends StatefulWidget {
  final String id;
  DeanCalendar({this.id});
  @override
  _DeanCalendarState createState() => _DeanCalendarState();
}

class _DeanCalendarState extends State<DeanCalendar> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 0.4,
        leading: IconButton(icon: Icon(Icons.arrow_back_ios), onPressed: ()=> Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) => DeanHome(id: widget.id,), fullscreenDialog: true))),
