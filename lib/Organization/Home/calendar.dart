...
bool isWide =true;
class OrganizationCalendar extends StatefulWidget {
  final String id;
  OrganizationCalendar({this.id});
  @override

  _OrganizationCalendarState createState() => _OrganizationCalendarState();
}

class _OrganizationCalendarState extends State<OrganizationCalendar> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 0.4,
        leading: IconButton(icon: Icon(Icons.arrow_back_ios), onPressed: ()=> Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) => HomeOrganization(id: widget.id,), fullscreenDialog: true))),
      ...
      body: Column(
          ...
          children: <Widget>[
              ...
              Container(
                ...
                child: Center(
                  child: Text("Events List", style: TextStyle(
                  color: Colors.white,
                  fontFamily: "Mops",
                  fontSize: 20,
