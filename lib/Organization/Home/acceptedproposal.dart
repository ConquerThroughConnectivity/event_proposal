...
class OrganizationAcceptedProposal extends StatefulWidget {
  final String id;
  OrganizationAcceptedProposal({Key key, this.id}): super(key: key);
  @override
  _OrganizationAcceptedProposalState createState() => _OrganizationAcceptedProposalState();


  
}

class _OrganizationAcceptedProposalState extends State<OrganizationAcceptedProposal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Organization Accepted Proposal's", style: TextStyle(
           fontFamily: "Mops",
