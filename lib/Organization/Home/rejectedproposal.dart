...
class OrganizationRejected extends StatefulWidget {
  final String id;
  OrganizationRejected({Key key, this.id}): super(key :key);
  @override
  _OrganizationRejectedState createState() => _OrganizationRejectedState();
}

class _OrganizationRejectedState extends State<OrganizationRejected> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Organization Rejected Proposal's", style: TextStyle(
           fontFamily: "Mops",
