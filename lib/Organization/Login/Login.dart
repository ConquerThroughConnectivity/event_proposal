...
class LoginOrganization extends StatefulWidget {
  @override
  _LoginOrganizationState createState() => _LoginOrganizationState();
}

class _LoginOrganizationState extends State<LoginOrganization> {
  @override
  Widget build(BuildContext context) {
    ScreenUtil.instance = ScreenUtil(
      ...
      return WillPopScope(
        child: Scaffold(
        appBar: AppBar(
          title: Text('Event Proposal Organization', style: TextStyle(
            fontFamily: "Mops",
                              ...
                              if(values==null){
                                ...
                                values.forEach((key,values){
                                  if(values["id"]==schoolID.text && values["password"]==password.text){
                                    ...
                                    password.clear();
                                    print(values["id"]);
                                    Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) =>HomeOrganization(id: values["id"].toString(),), fullscreenDialog: true));
                                  });
                                  }else{
                                  setState(() {
                                    isload =false;
  ...
  void popupInvalid(String message) {
    Flushbar(
      ...
      messageText: Text(
        message,
        style: TextStyle(fontSize: 17.0, color: Color(0xFFFF3345)),
      ),
