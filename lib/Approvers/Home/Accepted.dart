...
class ApproverAccepted extends StatefulWidget {
  final String orgname;
  ApproverAccepted({Key key, this.orgname}): super(key: key);
  @override
  _ApproverAcceptedState createState() => _ApproverAcceptedState();
}

class _ApproverAcceptedState extends State<ApproverAccepted> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Accepted Event", style: TextStyle(
           fontFamily: "Mops",
